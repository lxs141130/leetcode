...
public class TwoSum {
	 ...
	 * Example 1:
	 * 
	 * Input: nums = [1, 1, 2, 45, 46, 46], target = 47 Output: 2 Explanation: 1 +
	 * 46 = 47 2 + 45 = 47 Example 2:
	 * 
	 * Input: nums = [1, 1], target = 2 Output: 1 Explanation: 1 + 1 = 2
	 */
	public static int uniquePairs(int[] nums, int target) {
		Set<Integer> set = new HashSet<Integer>();
		Set<Integer> seen = new HashSet<Integer>();// when this is res, add to seen
		int count = 0;
		for (int num : nums) {
